...
export default function ErorPage() {
  return (
    <div style={{marginTop:"10%"}}><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="bi bi-emoji-dizzy-fill text-warning" viewBox="0 0 16 16">
